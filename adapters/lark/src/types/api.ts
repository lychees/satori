...
*/
    ...
    */
    ...
    /**
    * 获取指标库
    * @see https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/okr-v1/metric_source/list
    */
    listOkrMetricSource(query: ListOkrMetricSourceQuery): Promise<ListOkrMetricSourceResponse>
    /**
    * 获取指标表
    * @see https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/okr-v1/metric_source-table/list
    */
    listOkrMetricSourceTable(metric_source_id: string, query: ListOkrMetricSourceTableQuery): Promise<ListOkrMetricSourceTableResponse>
    /**
    * 更新指标项
    * @see https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/okr-v1/metric_source-table-item/patch
    */
    patchOkrMetricSourceTableItem(metric_source_id: string, metric_table_id: string, metric_item_id: string, params: PatchOkrMetricSourceTableItemRequest, query: PatchOkrMetricSourceTableItemQuery): Promise<PatchOkrMetricSourceTableItemResponse>
    /**
    * 批量更新指标项
    * @see https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/okr-v1/metric_source-table-item/batch_update
    */
    batchUpdateOkrMetricSourceTableItem(metric_source_id: string, metric_table_id: string, params: BatchUpdateOkrMetricSourceTableItemRequest, query: BatchUpdateOkrMetricSourceTableItemQuery): Promise<BatchUpdateOkrMetricSourceTableItemResponse>
    /**
    * 获取指标项
    * @see https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/okr-v1/metric_source-table-item/list
    */
    listOkrMetricSourceTableItem(metric_source_id: string, metric_table_id: string, query: ListOkrMetricSourceTableItemQuery): Promise<ListOkrMetricSourceTableItemResponse>
    /**
    * 获取指标项详情
    * @see https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/okr-v1/metric_source-table-item/get
    */
    getOkrMetricSourceTableItem(metric_source_id: string, metric_table_id: string, metric_item_id: string, query: GetOkrMetricSourceTableItemQuery): Promise<GetOkrMetricSourceTableItemResponse>
    /**
    * 录入身份信息
...
export type EnumFieldSetting = {
  /** 枚举选项信息 */
  enum_field_option_list?: CommonSchemaOption[]
  /** 是否为多选 */
  is_multiple?: boolean
}
...
export type CustomField = {
  ...
  /** 自定义字段类型 */
  type: number
  /** 配置信息，当前仅字段类型为「文本」、「布尔」、「数字」、「选项」、「日期时间」、「查找」、「附件」、「图片」时返回具体的配置信息，其余类型的自定义字段暂不返回 */
...
export type TransferInfo = {
  ...
  /** 原成本中心分摊信息 */
  original_cost_center_rate?: SupportCostCenterItem[]
  /** 新成本中心分摊信息 */
  target_cost_center_rate?: SupportCostCenterItem[]
}
...
export type Talent = {
  ...
  /** 自定义模块 */
  customized_data_list?: TalentCustomizedData[]
  /** 最高学历 */
  top_degree?: number
  /** 第一学历 */
  first_degree?: number
...
export type OkrObjectiveKr = {
  ...
  /** 该KR的进度列表 */
  progress_record_list?: ProgressRecordSimplify[]
  /** 最后一次进度百分比更新时间 毫秒 */
  ...
  deadline?: string
  /** 该Objective提到的人员列表 */
  mentioned_user_list?: OkrObjectiveAlignedObjectiveOwner[]
}
...
export type InterviewDimensionAssessment = {
  ...
  /** 当题目类型为多选题时，从此取值 */
  dimension_score_list?: InterviewDimensionScore[]
  /** 题目类型 */
...
export interface ListOkrMetricSourceQuery {
  /** 页码标识，获取第一页传空，每次查询会返回下一页的page_token */
  page_token?: string
  /** 每页获取记录数 */
  page_size?: string
}
export interface ListOkrMetricSourceTableQuery {
  /** 页码标识，获取第一页传空，每次查询会返回下一页的page_token */
  page_token?: string
  /** 每页获取记录数 */
  page_size?: string
}
export interface PatchOkrMetricSourceTableItemRequest {
  /** 指标起始值 */
  metric_initial_value?: number
  /** 指标目标值 */
  metric_target_value?: number
...
export interface PatchOkrMetricSourceTableItemQuery {
  /** 此次调用中使用的用户ID的类型 */
  user_id_type?: string
}
export interface BatchUpdateOkrMetricSourceTableItemRequest {
  /** 指标列表 */
  items: MetricItemRequest[]
}
export interface BatchUpdateOkrMetricSourceTableItemQuery {
  /** 此次调用中使用的用户ID的类型 */
  user_id_type?: string
}
export interface ListOkrMetricSourceTableItemQuery {
  /** 此次调用中使用的用户ID的类型 */
  user_id_type?: string
  /** 页码标识，获取第一页传空，每次查询会返回下一页的page_token */
  page_token?: string
...
export interface GetOkrMetricSourceTableItemQuery {
  /** 此次调用中使用的用户ID的类型 */
  user_id_type?: string
}
...
export interface SimplelistContactGroupResponse extends BaseResponse {
  data: Paginated<Group[], 'grouplist'>
}
...
export interface ListContactCustomAttrResponse extends BaseResponse {
  data: Paginated<CustomAttr[], 'items'>
}
...
export interface ListContactEmployeeTypeEnumResponse extends BaseResponse {
  data: Paginated<EmployeeTypeEnum[], 'items'>
}
...
export interface ChildrenContactDepartmentResponse extends BaseResponse {
  data: Paginated<Department[], 'items'>
}
...
export interface ListContactFunctionalRoleMemberResponse extends BaseResponse {
  data: Paginated<FunctionalRoleMember[], 'members'>
}
...
export interface ListContactJobFamilyResponse extends BaseResponse {
  data: Paginated<JobFamily[], 'items'>
}
...
export interface ListImMessageReactionResponse extends BaseResponse {
  data: Paginated<MessageReaction[], 'items'>
}
...
export interface GetImChatModerationResponse extends BaseResponse {
  data: Paginated<ListModerator[], 'items'>
}
...
export interface GetImChatMembersResponse extends BaseResponse {
  data: Paginated<ListMember[], 'items'>
}
...
export interface ListDrivev1FileViewRecordResponse extends BaseResponse {
  data: Paginated<FileViewRecord[], 'items'>
}
...
export interface ListDrivev1FileCommentResponse extends BaseResponse {
  data: Paginated<FileComment[], 'items'>
}
...
export interface ListDrivev1FileCommentReplyResponse extends BaseResponse {
  data: Paginated<FileCommentReply[], 'items'>
}
...
export interface ListBitableAppDashboardResponse extends BaseResponse {
  data: Paginated<AppDashboard[], 'dashboards'>
}
...
export interface ListBitableAppTableViewResponse extends BaseResponse {
  data: Paginated<AppTableView[], 'items'>
}
...
export interface ListBitableAppTableFormFieldResponse extends BaseResponse {
  data: Paginated<AppTableFormField[], 'items'>
}
...
export interface ListBitableAppTableRecordResponse extends BaseResponse {
  data: Paginated<AppTableRecord[], 'items'>
}
...
export interface ListBitableAppTableFieldResponse extends BaseResponse {
  data: Paginated<AppTableFieldForList[], 'items'>
}
...
export interface ListBitableAppRoleMemberResponse extends BaseResponse {
  data: Paginated<AppRoleMember[], 'items'>
}
export interface ListWikiSpaceResponse extends BaseResponse {
  data: Paginated<Space[], 'items'>
}
...
export interface ListCalendarCalendarAclResponse extends BaseResponse {
  data: Paginated<CalendarAcl[], 'acls'>
}
...
export interface SearchCalendarCalendarEventResponse extends BaseResponse {
  data: Paginated<CalendarEvent[], 'items'>
}
...
export interface ListCalendarCalendarEventAttendeeResponse extends BaseResponse {
  data: Paginated<CalendarEventAttendee[], 'items'>
}
export interface ListCalendarCalendarEventAttendeeChatMemberResponse extends BaseResponse {
  data: Paginated<CalendarEventAttendeeChatMember[], 'items'>
}
...
export interface ListByNoVcMeetingResponse extends BaseResponse {
  data: Paginated<Meeting[], 'meeting_briefs'>
}
...
export interface ListVcRoomLevelResponse extends BaseResponse {
  data: Paginated<RoomLevel[], 'items'>
}
...
export interface ListAttendanceShiftResponse extends BaseResponse {
  data: Paginated<Shift[], 'shift_list'>
}
...
export interface ListAttendanceGroupResponse extends BaseResponse {
  data: Paginated<GroupMeta[], 'group_list'>
}
...
export interface ListApprovalInstanceCommentResponse extends BaseResponse {
  data: Paginated<Comment[], 'comments'>
}
...
export interface ListApprovalExternalTaskResponse extends BaseResponse {
  data: Paginated<ExternalTaskList[], 'data'>
}
export interface QueryApprovalInstanceResponse extends BaseResponse {
  data: Paginated<InstanceSearchItem[], 'instance_list'>
}
...
export interface ListTaskv1TaskCollaboratorResponse extends BaseResponse {
  data: Paginated<Collaborator[], 'items'>
}
...
export interface ListTaskv2SectionResponse extends BaseResponse {
  data: Paginated<SectionSummary[], 'items'>
}
export interface TasksTaskv2SectionResponse extends BaseResponse {
  data: Paginated<TaskSummary[], 'items'>
}
...
export interface ListMailMailgroupMemberResponse extends BaseResponse {
  data: Paginated<MailgroupMember[], 'items'>
}
...
export interface CreateMailMailgroupPermissionMemberResponse extends BaseResponse {
  data?: MailgroupPermissionMember
}
...
export interface ListMailMailgroupPermissionMemberResponse extends BaseResponse {
  data: Paginated<MailgroupPermissionMember[], 'items'>
}
...
export interface ListMailPublicMailboxMemberResponse extends BaseResponse {
  data: Paginated<PublicMailboxMember[], 'items'>
}
...
export interface ListMailUserMailboxAliasResponse extends BaseResponse {
  data: Paginated<EmailAlias[], 'items'>
}
...
export interface UnderauditlistApplicationResponse extends BaseResponse {
  data: Paginated<Application[], 'items'>
}
...
export interface ListApplicationApplicationAppVersionResponse extends BaseResponse {
  data: Paginated<ApplicationAppVersion[], 'items'>
}
...
export interface ListPersonalSettingsSystemStatusResponse extends BaseResponse {
  data: Paginated<SystemStatus[], 'items'>
}
...
export interface ListSearchDataSourceResponse extends BaseResponse {
  data: Paginated<DataSource[], 'items'>
}
...
export interface ParentsCorehrDepartmentResponse extends BaseResponse {
  data: Paginated<DepartmentParents[], 'items'>
}
...
export interface SearchCorehrJobChangeResponse extends BaseResponse {
  data: Paginated<JobChange[], 'items'>
}
...
export interface SearchCorehrOffboardingResponse extends BaseResponse {
  data: Paginated<Offboarding[], 'items'>
}
...
export interface ListHireTalentFolderResponse extends BaseResponse {
  data: Paginated<TalentFolder[], 'items'>
}
...
export interface ListHireEvaluationResponse extends BaseResponse {
  data: Paginated<Evaluation[], 'items'>
}
...
export interface ListHireResumeSourceResponse extends BaseResponse {
  data: Paginated<ResumeSource[], 'items'>
}
...
export interface ListOkrMetricSourceResponse extends BaseResponse {
  data?: {
    /** 符合条件的记录总数 */
    total: number
    /** 是否有下一页 */
...
export interface ListOkrMetricSourceTableResponse extends BaseResponse {
  data?: {
    /** 符合条件的记录总数 */
    total: number
    /** 是否有下一页 */
...
export interface PatchOkrMetricSourceTableItemResponse extends BaseResponse {
  data?: {
    /** 指标表ID */
    metric_item_id: string
    /** 指标承接人员ID */
...
export interface BatchUpdateOkrMetricSourceTableItemResponse extends BaseResponse {
  data?: {
    /** 指标项列表 */
    items?: MetricItem[]
    /** 更新失败列表 */
    failed_items?: FailedMetricItem[]
  }
}
export interface ListOkrMetricSourceTableItemResponse extends BaseResponse {
  data?: {
    /** 符合条件的记录总数 */
    total: number
    /** 是否有下一页 */
...
export interface GetOkrMetricSourceTableItemResponse extends BaseResponse {
  data?: {
    /** 指标表ID */
    metric_item_id: string
    /** 指标承接人员ID */
...
export interface ListAcsAccessRecordResponse extends BaseResponse {
  data: Paginated<AccessRecord[], 'items'>
}
...
export interface ListBaikeEntityResponse extends BaseResponse {
  data: Paginated<Entity[], 'entities'>
}
...
export interface ListBaikeClassificationResponse extends BaseResponse {
  data: Paginated<Classification[], 'items'>
}
...
export interface FavouriteApplicationResponse extends BaseResponse {
  data: Paginated<Application[], 'app_list'>
}
...
export interface ListApplicationAppRecommendRuleResponse extends BaseResponse {
  data: Paginated<AppRecommendRule[], 'rules'>
}
